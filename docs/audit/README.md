...
| F | [`18-ciir-scientific-standing.md`](18-ciir-scientific-standing.md) | **Where CIIR stacks up vs leading theories**: calibrated 0–10 league table (SM, GR, QM, Shannon, BFT, string theory…) with CIIR disaggregated into 4 layers — DDR substrate (5.4), semantic thesis (3.1), physics core (2.9), "TOE" claim (1.3). Verdict + shortest path up a tier |
